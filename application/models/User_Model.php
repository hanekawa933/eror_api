...
class User_Model extends CI_Model
{
    ...
    public function delete_cascade_user($id)
    {
        $get_id_laporan = $this->db->get_where('laporan', ['pelapor_id' => $id])->row_array();
        $this->db->delete('bukti_laporan', ['laporan_id' => $get_id_laporan['id']]);
        $this->db->delete('notifikasi', ['laporan_id' => $get_id_laporan['id']]);
        $this->db->delete('laporan', ['pelapor_id' => $id]);
        $this->db->delete('bukti_teknisi', ['user_id' => $id]);
